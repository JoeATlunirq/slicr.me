  ...
  const steps = [
    {
      ...
      description: "Upload your video or audio files. Slicr.me supports multiple tracks while keeping them in perfect sync.",
      features: [
  ...
  return (
    <section id="how-it-works" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">How Slicr.me Works</h2>
