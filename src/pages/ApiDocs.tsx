    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
             ...
             <table className="w-full text-sm border-collapse border border-border">
               ...
               <tbody>
                 ...
                 <tr>
                   ...
                   <td className="border border-border p-2">String</td>
                   <td className="border border-border p-2">Determines the response type for the processed audio. <br/>- <code className="font-mono">"url"</code> (default): Returns a JSON response. If <code className="font-mono">transcribe</code> is <code className="font-mono">false</code>, this JSON contains an <code className="font-mono">audioUrl</code>. If <code className="font-mono">transcribe</code> is <code className="font-mono">true</code>, this JSON contains both an <code className="font-mono">audioUrl</code> and an <code className="font-mono">srtUrl</code> (if transcription is successful). <br/>- <code className="font-mono">"binary"</code>: If <code className="font-mono">transcribe</code> is <code className="font-mono">false</code>, this returns the processed audio file directly as a binary stream. If <code className="font-mono">transcribe</code> is <code className="font-mono">true</code>, this option is overridden, and the API behaves as if <code className="font-mono">responseFormat: "url"</code> was set (i.e., returns a JSON response with <code className="font-mono">audioUrl</code> and <code className="font-mono">srtUrl</code>).</td>
        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-4">
             <div>
                <h4 className="font-semibold mb-2">cURL Example (JSON response when transcribe is true):</h4>
                 <p className="text-sm mb-2 text-muted-foreground">This example sets <code className="font-mono">responseFormat: "binary"</code> and <code className="font-mono">transcribe: true</code>. Because <code className="font-mono">transcribe</code> is true, the API will return a JSON response containing <code className="font-mono">audioUrl</code> and <code className="font-mono">srtUrl</code> (if transcription succeeds), overriding the binary format for this case. If <code className="font-mono">transcribe</code> were <code className="font-mono">false</code> with <code className="font-mono">responseFormat: "binary"</code>, then the audio would be streamed directly (add <code className="font-mono"> &gt; processed_audio.mp3</code> to save it).</p>
